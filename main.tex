...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%                     
% \title [mode = title]{Multi-phase field analysis of Al-Cu-Ni system utilizing DFT computed elasticity}  
%\title [mode = title]{Multi-phase field analysis of Al-Cu-Ni system utilizing temperature calibrated elasticity}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\author[a]{Shengyan Shang}[]
%\ead{ssyan@git.edu.cn}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%\author[a]{Xiangyu Li}[]
%\ead{1787481233@qq.com}
%\author[a]{Yulong Hu}[]
%\ead{434452887@qq.com}
%\author[a]{Yulong Hu}[]
%\author[a]{Chunjing Shi}[]
%\ead{1464801360@qq.com}
%\author[a]{Yaoxiang Geng}[]
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\author[b]{Wenhai Lin}[]
%\cormark[1]
...
%During the laser welding, pure argon gas through a nozzle at 20 L/min ﬂow rate was used for shielding. The parameters of Nd: YAG pulsed laser welding were tabulated in Tab.\ref{welding-parameter} 
...
Electromagnetic behavior - fundamental and applications

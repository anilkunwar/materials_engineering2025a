...
Li \textit{et al.} \cite{liu2014theoretical} & DFT-calibrated phase-field (domain walls) & Calculated domain wall energies in PbTiO$_3$ and BaTiO$_3$ via DFT, providing parameters for the gradient energy coefficient in phase-field models. Ensured realistic wall energies and thicknesses, enhancing the predictive accuracy of domain structures. \\

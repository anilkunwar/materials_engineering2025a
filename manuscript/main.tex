...
Montes\textit {et al.} \cite{montes2021accelerating}, Peivaste\textit {et al.} \cite{peivaste2022machine}, Smith \textit {et al.} \cite{smith2024physics} & Physics-informed surrogate + RL & ML surrogates (RNN, CNN, Physics-informed models) & Demonstrated real-time predictions of microstructure evolution, and domain-wall manipulation using physics-informed machine learning combined with reinforcement learning to optimize probe-induced domain switching and polarization trajectories. \\
\bottomrule
\end{tabular}
\end{table}
